...
module ComplexModule
  ...
  class Readonlyproperty
    ...
    #
    # Creates and initializes a new instance of the Readonlyproperty class.
    ...
    #
    # @return [ReadonlyObj] operation results.
    #
    ...
    def get_valid_async(custom_headers = nil)
      ...
      request_headers = {}
      path_template = 'complex/readonlyproperty/valid'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            ...
            result_mapper = ComplexModule::Models::ReadonlyObj.mapper()
    ...
    #
    # @param complex_body [ReadonlyObj]
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    #
    ...
    def put_valid_async(complex_body, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = ComplexModule::Models::ReadonlyObj.mapper()
