...
module ComplexModule
  ...
  class AutoRestComplexTestService < MsRest::ServiceClient
    ...
    # @return [BasicOperations] basic_operations
    ...
    # @return [Polymorphism] polymorphism
    attr_reader :polymorphism

    # @return [Polymorphicrecursive] polymorphicrecursive
    attr_reader :polymorphicrecursive

    # @return [Readonlyproperty] readonlyproperty
    attr_reader :readonlyproperty
    ...
    def initialize(credentials = nil, base_url = nil, options = nil)
      ...
      @readonlyproperty = Readonlyproperty.new(self)
    ...
    #
    def add_telemetry
        sdk_information = 'body_complex'
        if defined? ComplexModule::VERSION
          sdk_information = "#{sdk_information}/#{ComplexModule::VERSION}"
        end
