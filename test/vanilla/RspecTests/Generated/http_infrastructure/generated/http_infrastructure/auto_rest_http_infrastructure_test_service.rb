...
module HttpInfrastructureModule
  ...
  class AutoRestHttpInfrastructureTestService < MsRest::ServiceClient
    ...
    # @return [HttpFailure] http_failure
    attr_reader :http_failure

    # @return [HttpSuccess] http_success
    attr_reader :http_success

    # @return [HttpRedirects] http_redirects
    attr_reader :http_redirects

    # @return [HttpClientFailure] http_client_failure
    attr_reader :http_client_failure

    # @return [HttpServerFailure] http_server_failure
    attr_reader :http_server_failure

    # @return [HttpRetry] http_retry
    attr_reader :http_retry

    # @return [MultipleResponses] multiple_responses
    ...
    #
    def add_telemetry
        sdk_information = 'http_infrastructure'
        if defined? HttpInfrastructureModule::VERSION
          sdk_information = "#{sdk_information}/#{HttpInfrastructureModule::VERSION}"
        end
