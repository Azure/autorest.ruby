...
module LroModule
  ...
  class LRORetrys
    ...
    def put_async_relative_retry_succeeded(product = nil, custom_headers = nil)
      response = put_async_relative_retry_succeeded_async(product, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # response.
    #
    def put_async_relative_retry_succeeded_async(product = nil, custom_headers = nil)
      # Send request
      promise = begin_put_async_relative_retry_succeeded_async(product, custom_headers)
    ...
    #
    # Long running delete request, service returns a 500, then a 202 to the initial
    # request. Polls return this value until the last poll returns a ‘200’ with
    # ProvisioningState=’Succeeded’
    #
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    ...
    #
    # Long running delete request, service returns a 500, then a 202 to the initial
    # request. Poll the endpoint indicated in the Azure-AsyncOperation header for
    # operation status
    #
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    ...
    def delete_async_relative_retry_succeeded(custom_headers = nil)
      response = delete_async_relative_retry_succeeded_async(custom_headers).value!
      nil
    end
    ...
    # response.
    #
    def delete_async_relative_retry_succeeded_async(custom_headers = nil)
      # Send request
      promise = begin_delete_async_relative_retry_succeeded_async(custom_headers)
    ...
    # request, with 'Location' and 'Retry-After' headers, Polls return a 200 with a
    ...
    def post_async_relative_retry_succeeded(product = nil, custom_headers = nil)
      response = post_async_relative_retry_succeeded_async(product, custom_headers).value!
      nil
    end
    ...
    # response.
    #
    def post_async_relative_retry_succeeded_async(product = nil, custom_headers = nil)
      # Send request
      promise = begin_post_async_relative_retry_succeeded_async(product, custom_headers)
    ...
    def begin_put201creating_succeeded200_async(product = nil, custom_headers = nil)
      ...
      path_template = 'lro/retryerror/put/201/creating/succeeded/200'
    ...
    def begin_put_async_relative_retry_succeeded(product = nil, custom_headers = nil)
      response = begin_put_async_relative_retry_succeeded_async(product, custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_put_async_relative_retry_succeeded_with_http_info(product = nil, custom_headers = nil)
      begin_put_async_relative_retry_succeeded_async(product, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_put_async_relative_retry_succeeded_async(product = nil, custom_headers = nil)
      ...
      path_template = 'lro/retryerror/putasync/retry/succeeded'
    ...
    def begin_delete_provisioning202accepted200succeeded_async(custom_headers = nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'lro/retryerror/delete/provisioning/202/accepted/200/succeeded'
    ...
    def begin_delete202retry200_async(custom_headers = nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'lro/retryerror/delete/202/retry/200'
    ...
    def begin_delete_async_relative_retry_succeeded(custom_headers = nil)
      response = begin_delete_async_relative_retry_succeeded_async(custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_delete_async_relative_retry_succeeded_with_http_info(custom_headers = nil)
      begin_delete_async_relative_retry_succeeded_async(custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_delete_async_relative_retry_succeeded_async(custom_headers = nil)
      ...
      request_headers['x-ms-client-request-id'] = SecureRandom.uuid
      request_headers['accept-language'] = @client.accept_language unless @client.accept_language.nil?
      path_template = 'lro/retryerror/deleteasync/retry/succeeded'
    ...
    def begin_post202retry200_async(product = nil, custom_headers = nil)
      ...
      path_template = 'lro/retryerror/post/202/retry/200'
    ...
    def begin_post_async_relative_retry_succeeded(product = nil, custom_headers = nil)
      response = begin_post_async_relative_retry_succeeded_async(product, custom_headers).value!
      nil
    end
    ...
    # @return [MsRestAzure::AzureOperationResponse] HTTP response information.
    #
    def begin_post_async_relative_retry_succeeded_with_http_info(product = nil, custom_headers = nil)
      begin_post_async_relative_retry_succeeded_async(product, custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def begin_post_async_relative_retry_succeeded_async(product = nil, custom_headers = nil)
      ...
      path_template = 'lro/retryerror/postasync/retry/succeeded'
