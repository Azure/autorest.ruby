...
module LroModule
  ...
  class AutoRestLongRunningOperationTestService < MsRestAzure::AzureServiceClient
    ...
    # @return [LRORetrys] lroretrys
    attr_reader :lroretrys

    # @return [LROSADs] lrosads
    attr_reader :lrosads

    # @return [LROsCustomHeader] lros_custom_header
    ...
    def add_telemetry
        sdk_information = 'lro'
        if defined? LroModule::VERSION
          sdk_information = "#{sdk_information}/#{LroModule::VERSION}"
        end
